...
class BankAccount:
    ...
    ##########
    _nextTransactionNumber = 100 # private class variable that holds the next transaction number for the bank account
    ##########
    ...
    def __init__(self, accountType: str, balance: float = 0.0, accountNumber:int = _nextAccountNumber ):
    ...
    def _createTransaction(self, transType: str, amount: float):
        transaction = Transaction(transType, amount, BankAccount._nextTransactionNumber)
        # increase transaction number by 1
        BankAccount._nextTransactionNumber = BankAccount._nextTransactionNumber + 1

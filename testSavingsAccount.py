...
class TestSavingsAccount(unittest.TestCase):
    ...
    def setUp(self):
        self.savings1 = SavingsAccount(TestSavingsAccount.ACCOUNT_NUMBER, TestSavingsAccount.SAVINGS_ONE_BALANCE)
        self.savings2 = SavingsAccount(TestSavingsAccount.ACCOUNT_NUMBER, TestSavingsAccount.SAVINGS_TWO_BALANCE)
        self.savings3 = SavingsAccount(TestSavingsAccount.ACCOUNT_NUMBER)
        self.savings4 = SavingsAccount(TestSavingsAccount.ACCOUNT_NUMBER, TestSavingsAccount.SAVINGS_FOUR_BALANCE)
        
        # test to ensure assertions function in constructor
        for i in range(len(TestSavingsAccount.INVALID_INPUTS)):
            with self.assertRaises(AssertionError):
                self.savings5 = SavingsAccount(TestSavingsAccount.ACCOUNT_NUMBER, TestSavingsAccount.INVALID_INPUTS[i])
    ...
    def testAddTransaction(self):
        account = SavingsAccount(TestSavingsAccount.ACCOUNT_NUMBER)
